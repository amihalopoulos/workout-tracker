...
# test_user = User.new(name: "alexei", password: "yolo", email: "test@gmail.com")
...
# exercise_list.each do |key, value|
#   body = BodyCategory.find_or_create_by(name: value)
#   body.exercise_categories.find_or_create_by(name: key)
# end

# #898
# # Chest, lats, biceps, middle back, forearms, quadriceps, hamstrings, abdominals, lower back, shoulders, traps, triceps, abductors, glutes, calves, nack
